...
const getBackupSchedule = () => process.env.BACKUP_CRON || "50 11 * * *";
const getBackupScheduleLabel = () => "Daily 11:50 AM IST";
...
// ── Auto scheduler — 11:50 AM IST every day ───────────────────
function startAutoBackupScheduler() {
  ...
  getBackupSchedule(),
  async () => {
    console.log("[Auto Backup] 11:50 AM IST triggered —", new Date().toISOString());
    try {
  ...
  console.log("[Auto Backup] ✅ Scheduler ready — 11:50 AM IST daily");
}
