...
const getBackupSchedule = () => process.env.BACKUP_CRON || "30 18 * * *";
const getBackupScheduleLabel = () => "Daily 6:30 PM IST";
...
// ── Auto scheduler — 6:30 PM IST every day ───────────────────
function startAutoBackupScheduler() {
  ...
  getBackupSchedule(),
  async () => {
    console.log("[Auto Backup] 6:30 PM IST triggered —", new Date().toISOString());
    try {
  ...
  console.log("[Auto Backup] ✅ Scheduler ready — 6:30 PM IST daily");
}
